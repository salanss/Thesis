...
\hline \\[-1.8ex] 
\multicolumn{10}{@{} l}{\textit{Panel A: Instrumented with volume coefficient variation (\textit{VCV\textsubscript{USD}})}}
\\
\\
  VCV\textsubscript{USD}  &  & $-$0.023$^{***}$ & $-$0.042$^{***}$ & $-$0.008$^{***}$ & $-$0.023$^{***}$ & $-$0.012 & $-$0.029$^{**}$ & 0.011 & $-$0.003 \\ 
  &  & (0.006) & (0.009) & (0.001) & (0.004) & (0.009) & (0.011) & (0.007) & (0.017) \\ 
 AFTER & $-$0.054$^{***}$ &  &  &  &  &  &  &  &  \\ 
  & (0.014) &  &  &  &  &  &  &  &  \\ 
  TREATED & $-$0.017 &  &  &  &  &  &  &  &  \\ 
  & (0.011) &  &  &  &  &  &  &  &  \\ 
  AFTER\_TREATED & 0.024$^{***}$ &  &  &  &  &  &  &  &  \\ 
  & (0.006) &  &  &  &  &  &  &  &  \\ 
  LOG\_MKT\_CAP & $-$0.133$^{***}$ &  &  &  &  &  &  &  &  \\ 
  & (0.008) &  &  &  &  &  &  &  &  \\ 
  BM\_RATIO & $-$0.011 & $-$0.0001 & 0.003 & $-$0.001$^{***}$ & 0.001$^{***}$ & $-$0.002 & 0.001 & 0.001 & 0.003 \\ 
  & (0.008) & (0.002) & (0.002) & (0.0001) & (0.0002) & (0.001) & (0.001) & (0.001) & (0.002) \\ 
  LEVERAGE & $-$0.020 & 0.006$^{**}$ & 0.003 & 0.003$^{***}$ & 0.0003 & $-$0.005 & $-$0.008$^{***}$ & $-$0.001 & $-$0.003 \\ 
  & (0.018) & (0.003) & (0.003) & (0.0004) & (0.001) & (0.003) & (0.003) & (0.003) & (0.002) \\ 
  ROA & $-$0.048 & 0.080$^{***}$ & 0.053$^{***}$ & 0.009$^{***}$ & $-$0.012$^{**}$ & $-$0.043$^{**}$ & $-$0.066$^{***}$ & $-$0.053$^{***}$ & $-$0.074$^{***}$ \\ 
  & (0.163) & (0.007) & (0.005) & (0.003) & (0.006) & (0.021) & (0.023) & (0.009) & (0.024) \\ 
 \hline \\[-1.8ex] 
...
Adjusted R$^{2}$ & 0.506 & 0.170 &  & 0.361 &  & 0.090 &  & 0.130 &  \\ 
\hline \\[-1.8ex]
\\[-1.8ex] & \multicolumn{1}{c}{First stage} & \multicolumn{1}{c}{OLS} & \multicolumn{1}{c}{IV} & \multicolumn{1}{c}{OLS} & \multicolumn{1}{c}{IV} & \multicolumn{1}{c}{OLS} & \multicolumn{1}{c}{IV} & \multicolumn{1}{c}{OLS} & \multicolumn{1}{c}{IV} \\ 
\cline{3-10} 
...
\\[-1.8ex] & (1) & (2) & (3) & (4) & (5)\\ 
\hline \\[-1.8ex] 
\multicolumn{10}{@{} l}{\textit{Panel B: Instrumented with bid-ask spread (\textit{BA\_SPREAD})}}
\\
\\
  BA\_SPREAD &  & $-$0.249$^{***}$ & $-$1.811$^{***}$ & $-$0.057$^{***}$ & $-$1.037$^{***}$ & $-$0.213$^{***}$ & $-$1.244$^{**}$ & $-$0.041 & $-$0.128 \\ 
  &  & (0.051) & (0.434) & (0.015) & (0.159) & (0.059) & (0.504) & (0.048) & (0.724) \\ 
 AFTER & 0.001 &  &  &  &  &  &  &  &  \\ 
  & (0.003) &  &  &  &  &  &  &  &  \\ 
  TREATED & 0.002 &  &  &  &  &  &  &  &  \\ 
  & (0.001) &  &  &  &  &  &  &  &  \\ 
  ...
  LOG\_MKT\_CAP & $-$0.003$^{***}$ &  &  &  &  &  &  &  &  \\ 
  & (0.0005) &  &  &  &  &  &  &  &  \\ 
  BM\_RATIO & 0.004$^{***}$ & $-$0.002 & 0.010$^{*}$ & $-$0.002$^{***}$ & 0.005$^{***}$ & $-$0.002 & 0.006 & 0.002$^{*}$ & 0.003 \\ 
  & (0.001) & (0.002) & (0.005) & (0.0003) & (0.002) & (0.002) & (0.004) & (0.001) & (0.005) \\ 
  LEVERAGE & $-$0.012$^{***}$ & 0.006$^{*}$ & $-$0.017$^{*}$ & 0.003$^{***}$ & $-$0.011$^{**}$ & $-$0.006 & $-$0.021$^{***}$ & $-$0.003 & $-$0.005 \\ 
  & (0.004) & (0.004) & (0.010) & (0.001) & (0.005) & (0.005) & (0.008) & (0.004) & (0.007) \\ 
  ROA & $-$0.202$^{***}$ & 0.054$^{**}$ & $-$0.308$^{***}$ & 0.007 & $-$0.221$^{***}$ & $-$0.076$^{***}$ & $-$0.315$^{***}$ & $-$0.078$^{***}$ & $-$0.098 \\ 
  & (0.020) & (0.027) & (0.099) & (0.004) & (0.037) & (0.020) & (0.114) & (0.006) & (0.166) \\ 
 \hline \\[-1.8ex] 
Industry fixed effects & Yes & Yes & Yes & Yes & Yes & Yes & Yes & Yes & Yes \\ 
Year fixed effects & Yes & Yes & Yes & Yes & Yes & Yes & Yes & Yes & Yes \\ 
Treated firm obs. & 5,298 & 5,298 & 5,298 & 5,298 & 5,298 & 5,298 & 5,298 & 5,298 & 5,298 \\ 
...
Distinct control firms & 3,435 & 3,435 & 3,435 & 3,435 & 3,435 & 3,435 & 3,435 & 3,435 & 3,435 \\ 
Observations & 21,134 & 21,134 & 21,134 & 21,134 & 21,134 & 21,134 & 21,134 & 21,134 & 21,134 \\ 
Adjusted R$^{2}$ & 0.606 & 0.152 &  & 0.215 &  & 0.090 &  & 0.124 &  \\ 
\hline 
\hline \\[-1.8ex] 
\multicolumn{10}{r}{} \\ 
\end{longtable}
