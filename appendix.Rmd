...
\cline{2-6} 
\\[-1.8ex] & \multicolumn{1}{c}{First stage} & \multicolumn{4}{c}{Second state} \\ 
\cline{3-6} 
\\[-1.8ex] & VCV\_USD & FOR\_OWN & FOR\_BREADTH & FOR\_TO\_INST\_OWN & FOR\_TO\_INST\_BREADTH \\ 
\\[-1.8ex] & (1) & (2) & (3) & (4) & (5)\\ 
\hline \\[-1.8ex] 
\multicolumn{6}{@{} l}{\textit{Panel A: Instrumented with volume coefficient variation (\textit{VCV\_USD})}}
\\
\\
  VCV\_USD &  & $-$0.042$^{***}$ & $-$0.023$^{***}$ & $-$0.029$^{**}$ & $-$0.003 \\ 
