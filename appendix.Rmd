...
\subsection{Appendix A: Variable definitions}\label{appendix_a}
...
ggsave("figures2/parallel_trend1a_facet.pdf", 
       width = 8, height = 8, units = "in", device = cairo_pdf())

embed_fonts("figures2/parallel_trend1a_facet.pdf", outfile="figures2/parallel_trend1a_facet.pdf")
  
```

\subsection{Appendix B: Supplementary figure of the main quasi-natural experiment results}\label{appendix_b}

\begin{figure}[H]
\centering
\includegraphics[width = \linewidth]{figures2/parallel_trend1a_facet.pdf}
...
did_analyst <- read_rds("results/did_regression_matched1.rds")
...
ggsave("figures2/parallel_trend_analyst_a.pdf", 
       width = 8, height = 6, units = "in", device = cairo_pdf())

embed_fonts("figures2/parallel_trend_analyst_a.pdf", outfile="figures2/parallel_trend_analyst_a.pdf")
...
ggsave("figures2/parallel_trend_analyst_b.pdf", 
       width = 8, height = 6, units = "in", device = cairo_pdf())

embed_fonts("figures2/parallel_trend_analyst_b.pdf", outfile="figures2/parallel_trend_analyst_b.pdf")
  
```

\clearpage

\subsection{Appendix C: Robustness tables and figures}\label{appendix_c}

\begin{figure}[H]
\centering
\includegraphics[width = \linewidth]{figures2/parallel_trend_analyst_b.pdf}
